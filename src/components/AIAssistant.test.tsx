...
describe('AIAssistant', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render sidebar variant regardless of isOpen', () => {
      render(<AIAssistant {...defaultProps} variant="sidebar" isOpen={false} />);
      expect(screen.getAllByText('Flow AI').length).toBeGreaterThanOrEqual(1);
    });
  ...
  describe('Header', () => {
    ...
    it('should show board agent when activeBoard is provided', () => {
      ...
      render(<AIAssistant {...defaultProps} activeBoard={activeBoard} />);
  ...
  describe('Styling', () => {
    it('should apply overlay classes for overlay variant', () => {
      const { container } = render(<AIAssistant {...defaultProps} variant="overlay" />);
      expect(container.firstChild).toHaveClass('fixed');
      expect(container.firstChild).toHaveClass('w-96');
    });

    it('should apply sidebar classes for sidebar variant', () => {
      const { container } = render(<AIAssistant {...defaultProps} variant="sidebar" />);
    ...
    it('should apply board mode color scheme', () => {
      ...
      const { container } = render(<AIAssistant {...defaultProps} activeBoard={activeBoard} />);
